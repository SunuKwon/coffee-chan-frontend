  ...
  return (
    <>
          ...
          <>
            ...
            <div className="border border-solid p-4 flex justify-center">
              <div className="h-36 flex gap-4 justify-center">
                <div className="rounded-xl h-32 p-2 content-center hover:bg-red-200 active:bg-red-300"
                     onClick={ () => openPopup( '수출입계약서' ) }>
      ...
      <Popup
        ...
        renderContent={ () =>
          <img src={ `/image/${ popupProps.title !== '선적서류' ? 'invoice.jpg' : 'packingList.gif' }` }
        ...
        renderActions={ () =>
          <div className="flex w-full">
            ...
            <button
              className="flex-1 h-8 border-2 text-white font-bold bg-blue-600 rounded-xl shadow-xl select-none active:bg-red-700">
              인쇄
            </button>
          </div>
        }
